...
export function mensajePorCodigo(codigo: string): string {
  const mapa: Record<string, string> = {
    ...
    NO_ERES_RECEPTOR: 'Solo quien recibió este reto puede avisar que lo cumplió.',
    YA_RECLAMADA: 'Ya le avisaste a tu pareja — falta que confirme.',
    AUN_NO_RECLAMADA: 'Tu pareja todavía no avisa que lo cumplió.',
