// Logotipo de Baraja2: dos naipes cruzados con los palos de la baraja.
// Implementa BJ2-002
  ...
  return (
    ...
    >
      <span
        ...
        style={{ width: tamano * 0.62, height: tamano * 0.86, transform: 'rotate(-14deg) translateX(-15%)' }}
      >
        <Icono.pica
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-morado-marca"
